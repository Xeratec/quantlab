...
from systems.GLUE.utils.statistics import GLUEStatistic
...
class iBertStatistic(GLUEStatistic):

    def __init__(self,
                 platform: PlatformManager, writerstub: WriterStub,
                 n_epochs: int, n_batches: int,
                 train: bool):
        super(iBertStatistic, self).__init__(platform=platform, writerstub=writerstub,
